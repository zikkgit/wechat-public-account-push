export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe682ad778b7b7ce3",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8b06950e2827cfa0de533ecd9f9d956c",
  ...
  USERS: [
    {
      ...
      id: "onqEy555JoYqRgV7q1xfv4c3Ydzk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "QC4XxRY4-UXRK78gsAAiLswajDRsc6XCjysa0MMeqjo",
      // 所在省份
      province: "北京",
      // 所在城市
      city: "海淀区",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2004", "date": "04-15"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "李四", "year": "2004", "date": "04-10"},
  ...
  CALLBACK_TEMPLATE_ID: "QC4XxRY4-UXRK78gsAAiLswajDRsc6XCjysa0MMeqjo",
